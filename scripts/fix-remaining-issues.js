...
// Files that need to be fixed (remove incorrect default exports)
const filesToFix = [
...
function fixFile(filePath) {
  try {
    ...
    // Remove the incorrect default export that was added
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      // Skip the incorrect default export section
...
// Process all files
console.log('Fixing incorrect default exports...');
