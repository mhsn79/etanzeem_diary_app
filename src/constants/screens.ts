...
export const SCREENS = {
  ...
  INCOME: 'Income',
  BAITULMAL: 'Baitulmal',
  BAITULMAL_SCREEN: 'BaitulmalScreen',
  MEETINGS: 'Meetings',
...
export const SCREEN_PATHS = {
  ...
  BAITULMAL: `/${SCREEN_GROUPS.STACK}/${SCREENS.BAITULMAL}`,
  BAITULMAL_SCREEN: `/${SCREEN_GROUPS.STACK}/${SCREENS.BAITULMAL_SCREEN}`,
...
export const SCREEN_TITLES = {
  ...
  [SCREENS.BAITULMAL]: 'بیت المال',
  [SCREENS.BAITULMAL_SCREEN]: 'بیت المال',
